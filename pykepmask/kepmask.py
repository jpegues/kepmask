...
class KepMask():
    ...
    def plot_product(self, prod, dosave=False, savename="testing.png", figsize=(8,8), title="", ncol=7, xlim=[-3.0, 3.0], ylim=[-3.0, 3.0], color="black", cmap=plt.cm.bone_r, vmin=0.0, vmax=None, vrange_kms=None, textsize=14, titlesize=16, linewidth=3.0, linestyle="-", alpha=0.5, beamx=0.85, beamy=0.15):
        """
        METHOD: plot_product
